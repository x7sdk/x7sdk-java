...
public class PaymentOrderEncryptedRequest {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof PaymentOrderEncryptedRequest)) {
            return false;
        }
        PaymentOrderEncryptedRequest that = (PaymentOrderEncryptedRequest) o;
    ...
    public int hashCode() {
        return Objects.hash(extendsInfoData, gameArea, gameLevel, gameOrderId, gameCurrency, gamePrice, gameRoleId,
                gameRoleName, gameGuid, notifyId, subject, gameAccessVersion);
    }

    @Override
    public String toString() {
        return "PaymentOrderEncryptedRequest{" +
